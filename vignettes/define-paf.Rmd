...
```{r echo=FALSE, fig.cap="Predicted population mortality after five years after modifying current smokers to never smoked. The PAF (which is the proportional difference between the two mortalities) is approximately 0.158. Graphically, this can be seen in the modified bar being 15.8% smaller than the original."}
par(mar = c(3.1, 4.1, 1, 1))
barplot(c("Original" = 10000 * smoke_paf$incidence,
          "Modified" = 10000 * smoke_paf$incidence_star),
