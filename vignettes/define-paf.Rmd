...
```{r echo=FALSE, fig.cap="Predicted opulation mortality after five years after modifying current smokers to never smoked. The PAF (which is the proportional difference between the two mortalities) is approximately 0.158. Graphically, this can be seen in the modified bar being 15.8% smaller than the original."}
